 ...
 */
final class Version20241008135651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_exercice (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, exercice_id INT NOT NULL, date DATE NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_495234DA76ED395 (user_id), INDEX IDX_495234D89D40298 (exercice_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
